...
class UpComingTap extends StatefulWidget {
  const UpComingTap({Key? key}) : super(key: key);

  @override
  State<UpComingTap> createState() => _UpComingTapState();
}
            ...
            builder: (context, state) {
              ...
              return ListView(
                children: List.generate(cubit.invitationsModel!.data.length, (index) {
                  return Column(
                    children: [
                      InvitationCard(event: cubit.invitationsModel!.data[index], wait: true,isActive: false,),
