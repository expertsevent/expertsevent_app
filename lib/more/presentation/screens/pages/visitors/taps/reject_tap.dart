...
class RejectTap extends StatefulWidget {
  const RejectTap({Key? key}) : super(key: key);

  @override
  State<RejectTap> createState() => _RejectTapState();
}

class _RejectTapState extends State<RejectTap> {
  ...
  void initState() {
    ...
    cubit.getVisitors("reject-visitors");
  }
  @override
