              ...
              Padding(
                ...
                child: CustomCard(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        CustomText(text: "accountCreated".tr(),fontSize: 22,fontWeight: FontWeight.bold,),
                        const SizedBox(height: 20,),
                        CustomText(text: "Your account had been created successfully.".tr(),fontSize: 16,color: AppUI.disableColor,textAlign: TextAlign.center,),
